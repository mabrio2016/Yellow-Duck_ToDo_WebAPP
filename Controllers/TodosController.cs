...
namespace DotNetAppSqlDb.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            return View(new Todo { CreatedDate = DateTime.Now, DueDate = DateTime.Now });
        }
        ...
        public ActionResult Create([Bind(Include = "Description,CreatedDate,Done,DueDate")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Description,CreatedDate,Done,DueDate")] Todo todo)
        {
